                ...
                <div class="md:col-span-7 space-y-6 relative">
                    ...
                    <div v-if="!showCalendar && !showBulletin">
                        ...
                        <div class="bg-white p-4 rounded-lg shadow space-y-4">
                            ...
                            <div
                                v-for="(student, i) in showAllStudents
                                    ? bookedStudents
                                    : bookedStudents.slice(0, 3)"
                                :key="i"
                    ...
                    <div
                        v-if="showCalendar"
                        class="bg-white p-4 rounded-lg shadow space-y-6 relative"
                    >
                        <!-- 月份切換 -->
                        ...
                        <!-- 月曆表 -->
                        <table
                            class="w-full border-collapse border border-gray-300 text-center"
                        >
                            <thead>
                                <tr>
                                    <th
                            ...
                            <tbody>
                                <tr
                                    v-for="(week, wIndex) in Math.ceil(
                        ...
                        <div
                            v-if="selectedDate"
                            class="mt-6 bg-gray-100 p-4 rounded shadow"
                        >
                            <h3 class="font-semibold mb-3">
                                設定 {{ selectedDate }} 時段狀態
                            </h3>
                            <div class="space-y-3">
                                <div
                                    v-for="period in ['上午', '下午', '晚上']"
                                    :key="period"
                        ...
                        >
                            <div class="bg-white rounded-lg p-6 w-80">
                                ...
                                <button
                                    class="block mx-auto px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 cursor-pointer"
                                    @click="cancelModal"
                                >
                                    取消
                                </button>
                    ...
                    >
                        ...
                        <div
                            class="border border-black rounded-md overflow-hidden"
                        >
                            <input
                                v-model="newAnnouncement.title"
                                placeholder="輸入標題"
                                class="w-full p-2 bg-gray-100 focus:outline-none placeholder:font-semibold"
                            />
                            <textarea
                        ...
                        <div class="flex justify-end gap-4">
                            ...
                            <button
                                ...
                                class="px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 rounded cursor-pointer"
                            >
                                發佈
                            </button>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                :key="i"
                                class="border border-black p-3 rounded"
                            >
                                <div v-if="!a.editable">

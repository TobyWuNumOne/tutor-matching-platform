...
export const courseAPI = {
    ...
    searchCourses: (searchParams) =>
        api.get("/course/search", { params: searchParams }),
};
...
export const teacherAPI = {
    ...
    registerTeacher: (teacherData) =>
        api.post("/teacher/register", teacherData),
    ...
    updateTeacherInfo: (teacherData) =>
        api.put("/teacher/profile", teacherData),
...
export const studentAPI = {
    ...
    // 獲取當前用戶的學生資訊 (自動從JWT獲取用戶ID)
    getCurrentStudentProfile: () => api.get("/student/profile"),
    ...
    updateStudentInfo: (studentData) =>
        api.put("/student/profile", studentData),
};
...
export const bookingAPI = {
    ...
    getBookingsByStudentId: (studentId) =>
        api.get(`/booking/list?student_id=${studentId}`),
};

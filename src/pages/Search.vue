  ...
  <main class="pt-[110px] min-h-screen flex flex-col">
    ...
    <section class="flex-1 p-6 bg-gray-100 grid grid-cols-2 gap-4 sm:grid-cols-4 overflow-x-auto">
      ...
      >
        ...
        <!-- 預約按鈕 -->
        <button
          class="bg-[#3F3FF0] text-white px-4 py-2 rounded hover:bg-blue-700 transition"
        ...
        >
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full relative border border-gray-200">
                <button
                ...
                <div class="flex flex-col space-y-2">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">確認預約</button>
                    <button class="bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-400">發送訊息</button>
                    <button class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600" @click="closeModal">取消</button>
                </div>
            </div>
        </div>

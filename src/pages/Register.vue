...
<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100 relative">
    ...
    <div class="absolute top-4 left-4 flex items-center gap-4">
      <img src="../assets/customer-service-headset.png" class="w-20 h-20" />
      <h2 class="text-2xl font-bold">家教媒合平台</h2>
    </div>

    <!-- 註冊卡片 -->
    <div class="bg-white shadow-lg rounded-lg p-8 w-[90%] max-w-md space-y-6">
      <form class="space-y-4">
        ...
        <div class="grid gap-3">
          ...
          <input type="text" class="rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />

          <label class="text-sm font-medium">帳號（Email）</label>
          <input type="email" class="rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
        ...
        <!-- 註冊按鈕區 -->
        <div class="grid gap-3">
          <button class="bg-blue-600 text-white py-2 rounded-md text-center hover:bg-blue-700 transition cursor-pointer">
            註冊
          </button>
          ...
          <button class="bg-red-500 text-white py-2 rounded-md text-center hover:bg-red-600 transition cursor-pointer">
            使用 Google 註冊
          </button>
        </div>
        ...
        <p class="text-center text-sm text-gray-700">
          已有帳號？
          <RouterLink to="/login" class="text-blue-600 hover:underline">立即登入！</RouterLink>
        </p>
      </form>
    </div>
  </div>
